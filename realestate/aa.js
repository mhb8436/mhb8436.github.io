...
console.log(gugunCodeList.length);
console.log(gugunNameList.length);
console.log(gugunFullNameList.length);


var SRC_GUGUN_CODE = gugunCodeList.map(function(d, i){ return {'code':d, 'name':gugunNameList[i], 'fullname':gugunFullNameList[i]} });
