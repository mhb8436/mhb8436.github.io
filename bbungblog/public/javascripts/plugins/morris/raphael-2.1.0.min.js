...
(function(a){
	...
	k.on=function(a,b){
		...
		for(var g=0,h=c.length;g<h;g++)
			e=e.n,!e[c[g]]&&(e[c[g]]={n:{}}),e=e[c[g]];e.f=e.f||[];
		...
		for(k=0,l=o.length;k<l;k++){
			...
			while(g.n){
				if(b){
					...
					delete g.f;
					for(h in g.n)
						g.n[c](h)&&g.n[h].f&&delete g.n[h].f}g=g.n
			}
		}
	},
	k.once=function(a,b){
	...
	typeof module!="undefined"&&module.exports?module.exports=k:typeof define!="undefined"?define("eve",[],function(){return k}):a.eve=k})(this),
	function(){
		function cF(a){
						...
						if(j[g](A))
							if(U[g](A)||d.paper.customAttributes[g](A)){
								...
								case"transform":
									...
									if(I){
										...
										u[A]=[J.a,J.b,J.c,J.d,J.e,J.f],b$(K,v[A]),
										v[A]=K._.transform,w[A]=[(K.matrix.a-J.a)/t,(K.matrix.b-J.b)/t,(K.matrix.c-J.c)/t,
										(K.matrix.d-J.d)/t,(K.matrix.e-J.e)/t,(K.matrix.f-J.f)/t]
									}
									break;
								case"csv":
							...
							if(!P){
								...
								if(P&&P.length==5){
									...
									P=bf}q=j.start||b.start||+(new Date),
									x={anim:b,percent:e,timestamp:q,start:q+(b.del||0),status:0,initstatus:f||0,stop:!1,ms:t,easing:P,from:u,diff:w,to:v,el:d,callback:j.callback,prev:p,next:o,repeat:i||b.times,origin:d.attr(),totalOrigin:h},
									cy.push(x);
							if(f&&!k&&!l){
